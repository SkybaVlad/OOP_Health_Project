...
class ActivityAnalyzer:
    ...
    def build_donut_gradient(self, activity_summary: list[dict]) -> str:
        ...
        if current_degree < 360:
            gradient_parts.append(
                f"#D9D9D9 {current_degree}deg 360deg"
            )
    ...
    def get_activity_summary(self) -> list[dict]:
        ...
        for index, item in enumerate(main_activities):
            activity_name = item[0]
            activity_time = item[1]
        ...
        if other_activities:
            other_percent = 100 - used_percent
                ...
                activity_summary.append(
                    {
                        ...
                        "color": self.get_color_by_class("other-dot"),
                    }
                )
